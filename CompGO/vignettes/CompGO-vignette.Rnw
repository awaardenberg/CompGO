...
library(CompGO)
## Instead of using bandwidth downloading a full genome,
## we provide here something functionally identical but
## which doesn't require network access
## db = ucscDbDump(genome="mm9") # identical to:
data(ucsc.mm9)
db = ucsc.mm9
str(db)
@
